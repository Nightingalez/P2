...
public class DataManager {
    ...
    public static Recipe ActiveRecipe = new Recipe(new ArrayList<FoodItem>());
    ...
    public static void defaultDataGenerator() {
    ...
    public static void demoData1()
    {
        defaultDataGenerator();
    }

    public static void demoData2()
    {
        //This is basically a copy of the contents in the normal data generator
        //Default main categories
        Category meat = new Category("Meat", QuantityUnit.GRAMS);
        mainCategories.add(meat);
        ...
        //Create storage list
        DataManager.storage.addFoodItem(new FoodItem(tomato));
        DataManager.storage.addFoodItem(new FoodItem(rice));
        DataManager.storage.addFoodItem(new FoodItem(salt));
        DataManager.storage.addFoodItem(new FoodItem(cheese));
        DataManager.storage.addFoodItem(new FoodItem(chicken));
        DataManager.storage.addFoodItem(new FoodItem(eggs));
        DataManager.storage.addFoodItem(new FoodItem(onion));
        DataManager.storage.addFoodItem(new FoodItem(pepperoni));
        DataManager.storage.addFoodItem(new FoodItem(beef));
    }
